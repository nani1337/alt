...
<h2> Upload a Application </h2>
<?php error_message(); ?>
<table style="width:320px">
  <form enctype="multipart/form-data" action="<?=h( $_SERVER['PHP_SELF'] )?>" method="POST">
  <input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
       <tr><td>First Name :</td><td><input type="text" name="tag" style="" /></td></tr>
       <tr><td>Last Name :</td><td>  <input type="text" name="name" /></td></tr>
       <tr><td>Email :</td><td> <input type="text" name="title" /></td></tr>
       <tr><td>Phone :</td><td>  <input type="text" name="price" /></td></tr>
